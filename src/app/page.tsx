          ...
          <div className="grid md:grid-cols-3 gap-12 mb-12">
            ...
            <div className="space-y-6">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 className="text-xl font-bold text-white">Bouchiba Ahmed</h3>
              ...
              <div className="flex gap-4">
                <a
                  ...
                  className="glass-card p-3 hover:bg-white/10 text-gray-400 hover:text-white transition-all duration-300 rounded-lg"
                >
